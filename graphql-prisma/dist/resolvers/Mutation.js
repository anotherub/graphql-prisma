...
var _hashedPassword = require('../utils/hashedPassword');

var _hashedPassword2 = _interopRequireDefault(_hashedPassword);
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _hashedPassword2.default)(args.data.password);
